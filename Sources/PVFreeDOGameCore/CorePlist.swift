...
public extension PVBundleFinder {
    static var PVFreeDOGameCoreModule: Bundle { Bundle.module }
    static var PVFreeDOGameCoreBundle: Bundle { Bundle(for: PVFreeDOGameCore.self) }
}
#else
public extension PVBundleFinder {
    static public var PVFreeDOGameCoreBundle: Bundle { Bundle(for: PVFreeDOGameCore.self) }
}
#endif

@objc
extension PVFreeDOGameCore: EmulatorCoreInfoPlistProvider {
